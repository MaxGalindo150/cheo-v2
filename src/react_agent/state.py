...
class State(InputState):
    ...
    payment_bank: str = field(default="")
    payment_order: str = field(default="")
    payment_receipt_validated: bool = field(default=False)
    bank_validated: bool = field(default=False)
